...
-- Import your schema file into the mediease database
```
...
├── functions.php             # 35+ utility functions (auth, validation, formatting)
...
🫀 Cardiology · 🧠 Neurology · 👶 Pediatrics · 👁️ Ophthalmology · 🎨 Dermatology · 🦷 Dentistry
